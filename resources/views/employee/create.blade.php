                        ...
                        <div class="row">
                            ...
                            <div class="input-field col s12 m12 l12 xl8 offset-xl2">
                                ...
                                <select name="division">
                                    <option value="" disabled {{ old('division') ? '' : 'selected' }}>Choose a JobStatus</option>
                            ...
                            <div class="input-field col s12 m6 l6 xl8 offset-xl2">
                                ...
                                <textarea name="comment" id="comment" class="materialize-textarea" >{{Request::old('comment') ? : ''}}</textarea>
                                <label for="comment">Comment</label>
                                <span class="{{$errors->has('comment') ? 'helper-text red-text' : ''}}">{{$errors->has('comment') ? $errors->first('comment') : ''}}</span>
                            </div>
