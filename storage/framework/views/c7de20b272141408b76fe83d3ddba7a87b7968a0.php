<ul id="slide-out" class="sidenav sidenav-fixed grey lighten-4">
    <li>
        <div class="user-view">
            ...
            <a href="<?php echo e(route('auth.show')); ?>"><img class="circle" src="<?php echo e(asset('storage/admins/'.Auth::user()->picture)); ?>"></a>
            
            <a href="<?php echo e(route('auth.show')); ?>"><span class="white-text name"><?php echo e(Auth::user()->first_name); ?> <?php echo e(Auth::user()->last_name); ?></span></a>
            
            <a href="<?php echo e(route('auth.show')); ?>"><span class="white-text email"><?php echo e(Auth::user()->email); ?></span></a>
        </div>
    </li>
    <li>
