...
<div class="container">
    ...
    <?php $__env->startComponent('sys_mg.inc.search',['title' => 'Salaries' , 'route' => 'salaries.search' , 'type' => 'number']); ?>
    ...
    <div class="row">
        ...
        <div class="card col s12 m12 l12 xl12">
            <div class="card-content">
                            ...
                            <?php if($salaries->count()): ?>
                                <?php $__currentLoopData = $salaries; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $salary): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td><?php echo e($salary->s_amount); ?></td>
                                        <td><?php echo e($salary->created_at); ?></td>
                                        <td><?php echo e($salary->updated_at); ?></td>
                                        <td>
                                            <div class="row mb-0">
                                              <div class="col">
                                                    <a href="<?php echo e(route('salaries.edit',$salary->id)); ?>" class="btn btn-floating btn-small waves=effect waves-light orange"><i class="material-icons">mode_edit</i></a>
                                                </div>
                                                <div class="col">
                                                    <form action="<?php echo e(route('salaries.destroy',$salary->id)); ?>" method="POST">
                ...
                <div class="center">
                  <?php echo e($salaries->links('vendor.pagination.default',['paginator' => $salaries])); ?>
...
<div class="fixed-action-btn">
    <a class="btn-floating btn-large waves=effect waves-light red" href="<?php echo e(route('salaries.create')); ?>">
